...
<body>
  <nav class="navbar navbar-expand-md bg-body-tertiary bg-dark sticky-top" data-bs-theme="dark">
    <div class="container-fluid">
      ...
      <button class="btn btn-outline-warning d-md-none ms-2" type="button" data-bs-toggle="collapse"
        data-bs-target="#form_ricerca_wrapper" aria-controls="form_ricerca_wrapper" aria-expanded="false"
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-1 my-2 my-lg-0 dropdown-center">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
              <li><a class="dropdown-item" onclick="SwitchInputSelect(1)">Categoria</a></li>
              <li><a class="dropdown-item" onclick="SwitchInputSelect(2)">Parola chiave</a></li>
      ...
      <div class="collapse d-md-block" id="form_ricerca_wrapper">
        <form class="d-flex mt-2 mt-md-0" role="search" id="form_ricerca">
  ...
  <h1 id="intestazione">Ultime uscite</h1>
  ...
  <div class="container-fluid visually-hidden" id="graficaCards">
    <div class="row row-cols-1 row-cols-sm-3 row-gap-5" id="video"></div>
  </div>
  <br>
</body>
