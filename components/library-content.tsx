...
const systemPlaylists = [
  ...
  { id: "downloaded", name: "ownloaded", icon: CheckCircle, count: 0 },
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-muted-foreground">4 playlists</span>
      ...
      <div className="px-4 grid grid-cols-2 gap-4">
        ...
        <Link href="/dashboard/playlists">
          ...
          <h3 className="font-semibold mt-2">music 🎶</h3>
          <p className="text-sm text-muted-foreground">255 songs</p>
        </Link>

        <div className="aspect-square rounded-2xl bg-secondary flex items-center justify-center border-2 border-dashed border-muted-foreground/30">
